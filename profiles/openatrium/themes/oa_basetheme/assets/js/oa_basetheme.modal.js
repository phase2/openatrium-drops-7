...
(function ($) {
  ...
  Drupal.CTools.Modal.show = function(choice) {
    ...
    // Fix bug with system messages causing dialog to popup in wrong place
    // TODO: This is a core issue that needs investigating with Drupal modal.js
    // For now we just hide alert messages before opening the dialog
    var alerts = $('.alert');
    if (alerts.length > 0) {
      alerts.hide();
    }
