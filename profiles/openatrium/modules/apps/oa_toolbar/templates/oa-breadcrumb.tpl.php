...
<ul id="oa_breadcrumb" class="oa_toolbar">
  <?php if (!empty($space_label)): ?>
    ...
    <?php endif; ?>
    <li class="btn-group oa-breadcrumb dropdown">
      <a href="<?php print $space_url; ?>" class="btn <?php print $oa_toolbar_btn_class; ?>" id="oa-breadcrumb-space-link"><?php print $space_label; ?></a>
    ...
    <li class="btn-group oa-breadcrumb">
      <?php if (!empty($section_label)): ?>
        <a href="<?php print $section_url; ?>" class="btn <?php print $oa_toolbar_btn_class; ?>" id="oa-breadcrumb-section-link"><?php print $section_label; ?></a>
      <?php endif; ?>
    </li>
    <?php endif; ?>
  <?php endif; ?>
